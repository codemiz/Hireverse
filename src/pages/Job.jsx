...
function Job({title , company ,description , education , age , experience ,salary, location , isVerified}) {
  return (
    <div className='w-full flex flex-col gap-4 items-center py-2'>

        <div className="job-div bg-gray-50 w-[90%] lg:w-3/4 xl:w-3/5 2xl:w-1/2 h-48 border border-gray-300 rounded-2xl shadow flex flex-col pl-4 pr-8 py-3 justify-between">
            <div>
